...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: "/officeBuildingPeopleSpec/list",
        add: "/officeBuildingPeopleSpec/add",
        edit: "/officeBuildingPeopleSpec/edit",
        delete: "/officeBuildingPeopleSpec/delete",
      },
      labelCol: {
        xs: { span: 24 },
        sm: { span: 5 },
